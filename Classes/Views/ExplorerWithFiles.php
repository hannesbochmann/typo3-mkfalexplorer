...
class Tx_Mkfalexplorer_Views_ExplorerWithFiles extends tx_rnbase_view_Base {
	...
	private static function makeExplorer($arr, $configurations, $storageId)
	{
		...
		$linkUtility = tx_rnbase::makeInstance('Tx_Mkfalexplorer_Utility_Path', $configurations);
			...
			if(@get_class(array_values($value)[0]) =='TYPO3\CMS\Core\Resource\File'){
				...
				foreach ($value as $file) {
					...
					tx_rnbase_util_Misc::callHook(
						'mkfalexplorer',
						'Tx_Mkfalexplorer_Views_ExplorerWithFiles_makeExplorerFileAdditionalContent',
						array(
							'file' => &$file,
